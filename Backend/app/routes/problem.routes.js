...
module.exports = function (app) {
  app.post("/api/problems", [authJwt.verifyToken, authJwt.isModeratorOrAdmin], controller.create);
  ...
  app.put("/api/problems/:id", [authJwt.verifyToken, authJwt.isModeratorOrAdmin], controller.update);
  app.put(
