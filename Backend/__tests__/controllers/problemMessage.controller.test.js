...
describe('Problem Controller', () => {
  ...
  describe('findAll', () => {
    ...
    it('should handle errors and respond with 500', async () => {
      ...
      expect(res.json).toHaveBeenCalledWith({ message: 'Erreur lors de la récupération : Query error' });
    });
  });
  ...
  describe('create', () => {
    ...
    it('should handle error on create and respond 400', async () => {
      ...
      expect(res.json).toHaveBeenCalledWith({ message: 'Erreur lors de la création : Create err' });
    });
  });
