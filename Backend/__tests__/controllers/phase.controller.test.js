...
describe('Phase Controller', () => {
  describe('findAll', () => {
    ...
    it('should handle error and respond 500', async () => {
      ...
      expect(res.json).toHaveBeenCalledWith({ message: 'Erreur lors de la récupération : Fail' });
    });
  });
  ...
  describe('create', () => {
    it('should create a new phase and return it', async () => {
      ...
      expect(res.json).toHaveBeenCalledWith({ message: 'Phase créée avec succès', data: newPhase });
    });
  ...
  describe('update', () => {
    it('should update phase and return updated object', async () => {
      ...
      expect(res.json).toHaveBeenCalledWith({ message: 'Mise à jour réussie', data: updatedPhase });
    });
