...
export class PlanningPage implements OnInit {
  ...
  projects: Phase[] = [
    ...
    },
    {
      ...
      progress: 30,
      tasks: [
        { name: 'Coulage fondations', status: 'finished', schedule: [{ start: 1750233610, end: 1750266010 }]  },
    ...
    },
    {
      ...
      progress: 10,
      tasks: [
        { name: 'Dépose ancienne toiture', status: 'notStarted', schedule:  [{ start: 1750233610, end: 1750266010 }] }
      ]
    }
  ];
  ...
  sites = [{ label: 'Construction Maison Martin' }, { label: 'Réfection Toiture Dubois' }];
  ...
  getSchedulesForDay(task: Task, day: Date) {
    const dayStart = Math.floor(new Date(day.setHours(0, 0, 0, 0)).getTime() / 1000);
  ...
  prev()  { /* decale la semaine */ }
  next()  { /* avance la semaine */ }
  today() { /* revient à aujourd'hui */ }
}
